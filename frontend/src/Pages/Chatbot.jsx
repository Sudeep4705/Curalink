...
import { Paperclip,FlaskConical,UserRound} from "lucide-react";
...
export default function Chatbot() {
  ...
  <span className="font-bold text-gray-900 text-lg tracking-tight">CurALink</span>
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-gray-900 text-white text-xs font-semibold shadow-md ml-1">
